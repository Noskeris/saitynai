...
const CreateTimeSlotModal = ({ open, onClose, organizationId, eventId }) => {
    ...
    try {
        ...
        toastService.error(err.response?.data?.Errors?.details?.[0] || "Failed to create timeslot");
    } finally {
        setSubmitting(false);
    }
},
                ...
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <Box sx={{ textAlign: "right", marginTop: "1rem" }}>
                        <Button variant="contained" type="submit" disabled={formik.isSubmitting}>
                            {formik.isSubmitting ? "Saving..." : "Create Time Slot"}
                        </Button>
                    </Box>
                </form>
            </DialogContent>
