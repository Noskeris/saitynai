...
const EditEventModal = ({ open, onClose, organizationId, event }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { setSubmitting }) => {
            try {
                await updateEvent.mutateAsync({ organizationId, eventId, event: values });
                onClose();
            } catch (err) {
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <Box sx={{ textAlign: "right", marginTop: "1rem" }}>
                            <Button variant="contained" type="submit" disabled={formik.isSubmitting}>
                                {formik.isSubmitting ? "Saving..." : "Edit Event"}
                            </Button>
                        </Box>
                    </form>
                </DialogContent>
